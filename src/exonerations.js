...
export const exonerations = [
  ...
  },
  {
    name: 'JAMES FLETCHER',
    img: fletcher,
    bio: "Blagg obtains a rare outright reversal of Fletcher’s conviction in federal court after presenting evidence that Fletcher was framed by notorious CPD detectives. Judge orders the prosecution to release him or retry him, and the CCSAO drops all charges.",
    featured: false
  },
  {
    name: 'DAVID GECHT',
    img: gecht,
    bio: "Blagg, working with the Exoneration Project, secured the reversal of Gecht's conviction. A judge granted Gecht a new trial after the team presented evidence of the corrupt practices of CPD detective Reynaldo Guevara, who had framed Gecht.",
    featured: true,
