...
export const exonerations = [
  ...
  },
  {
    name: 'DAVID GECHT',
    img: gecht,
    bio: "Blagg, working with the Exoneration Project, secured the reversal of Gecht's conviction. Gecht recieved a new trial after the team presented evidence of the corrupt practices of Detective Guevara, who had framed Gecht.",
    featured: true,
